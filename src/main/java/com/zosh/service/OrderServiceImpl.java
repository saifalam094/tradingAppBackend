...
public class OrderServiceImpl implements OrderService {
    ...
    public Order getOrderById(Long orderId) {
        ...
        return order.orElseThrow(() -> new RuntimeException("Order not found for ID: " + orderId));
    }
    ...
    @Override
    public Order processOrdder(Coin coin, double quantity, OrderType orderType) throws Exception {
        return null;
    }
